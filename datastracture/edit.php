...
echo $edid;
// UPDATE `login_info` SET `firstName` = 'sfdasfaddddd' WHERE `login_info`.`id` = 22;
...
<form method="get" action="edit.php"  class="container my-4 bg-success py-5 rounded col-md-6">
  <div class="mb-3 mx-5">
...
$edsql = "UPDATE login_info SET firstName='Md', lastName='$name', email='$email', pwd='$pwd' WHERE id=$edid ";

mysqli_query($conn, $edsql);
